...
if (isset($_POST["Enviar"]) && $_POST["Enviar"] === "Guardar") {
    ...
    if (empty($id)) {
        $sql = "insert into productos( nombre, marca, detalle, precio,stock, foto)
    values ('$nombres','$marcas','$detalles','$precios','$stocks','$nombreArchivo')";
    //INSERT INTO productos( nombre, marca, detalle, foto, precio, stock) VALUES ('a','a','a','as','3','2');
    } else {
